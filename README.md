...
- [x] 4 - Implementar para fechar o bot pelo Telegram com o comando /stop

- [x] 5 - Multi Account (Windows).

- [ ] 6 - Multi Account (Linux). - Ao completar $200 em doações.

- [ ] 7 - BTS Herald (Receber ligação se o farm parar). Ao completar $500 em doações.
