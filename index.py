...
banner = """
******************************* BombCrypto Bot **********************************
1 101010101o       ,o101011o.    1 101010101o       ,o101011o. 1010111 1010101011
1 1010    `11.    1010     `11.  1 1010    `11.  . 1010     `11.     1 1010
1 0111     `11 ,1 1010       `1. 1 0111     `11 ,1 1010       `1b    1 1010
1 1001     ,11 11 1010           1 1001     ,11 11 1010        `1b   1 1010
1 0001.   ,11' 11 1010           1 0001.   ,11' 11 1010         11   1 1010
1 1010101011   11 1010           1 1010101011   11 1010         11   1 1010
1 0101    `11. 11 1010           1 0101    `11. 11 1010        ,1P   1 1010
1 1001      11 `1 1010       .1' 1 1001      11 `1 1010       ,1P    1 1010
1 1111    ,11'    1010     ,11'  1 1111    ,11'  ` 1010     ,11'     1 1010
1 110010101P       `1010111P'    1 110010101P       `1010111P'       1 1010
*********************************************************************************
...
def clickFullBarButtons():
    ...
    if len(not_working_full_bars) > 0:
        logger('Clicking in %d heroes with FULL bar detected.' %
               len(not_working_full_bars), telegram=False, emoji='👆')
...
def getMoreHeroes():
    ...
    logger('{} total heroes sent since the bot started'.format(
        heroes_clicked_total), telegram=False, emoji='🦸')
    goToTreasureHunt()
    ...
    if versionLocal is not None:
        ...
        if version > versionLocal:
            logger('New version ' + version +
                   ' available, please update', telegram=False, emoji='🎉'),
    else:
...
def main():
    ...
    logger('Starting bot...', telegram=False, emoji='🤖')
    logger('Join us on BCBOT Telegram group: https://t.me/+WXjrE1Kdb1U1Mzg0', telegram=False, emoji='💖')
    logger('Commands: \n\n /print \n /map \n /bcoin \n /invite \n /id \n /donation \n /pix \n\n /stop - Stop bot', telegram=False, emoji='ℹ️')
    logger('Multi Account BETA is available. Run: python index-ma.py and not index.py for tests.', telegram=False, emoji='💡')
